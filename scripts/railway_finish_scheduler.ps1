# Finaliza scheduler no projeto correto (pleasing-recreation / site-clickup).
...
$SchedulerName = "site-clickup-scheduler"
$GitHubRepo = "rogerppacheco/site-clickup"
...
Write-Host "=== Scheduler site-clickup (pleasing-recreation) ===" -ForegroundColor Cyan
...
if (Test-Path $configPath) {
    ...
    if ($cfg.projects.'C:\site-clickup') {
        $cfg.projects.'C:\site-clickup'.project = $ProjectId
        $cfg.projects.'C:\site-clickup'.environment = $EnvId
        $cfg.projects.'C:\site-clickup'.name = "pleasing-recreation"
        $cfg.projects.'C:\site-clickup'.service = $WebServiceId
    }
...
Write-Host "Web: site-clickup | Scheduler: $SchedulerName" -ForegroundColor Cyan
