#!/usr/bin/env bash
# Configura e faz deploy do serviço Railway "site-clickup-scheduler".
...
SCHEDULER_SERVICE="${RAILWAY_SCHEDULER_SERVICE:-site-clickup-scheduler}"
WEB_SERVICE="${RAILWAY_WEB_SERVICE:-}"
GITHUB_REPO="${RAILWAY_GITHUB_REPO:-rogerppacheco/site-clickup}"
...
WEB_SERVICE="${WEB_SERVICE:-site-clickup}"
