# Configura e faz deploy do serviço Railway "scheduler" (mesmo projeto do site-clickup).
...
# Projeto production site-clickup: pleasing-recreation (nao melodious-hope/viabilidade)
...
$SchedulerService = if ($env:RAILWAY_SCHEDULER_SERVICE) { $env:RAILWAY_SCHEDULER_SERVICE } else { "site-clickup-scheduler" }
...
Write-Host "=== Railway: servico scheduler (site-clickup) ===" -ForegroundColor Cyan
Test-RailwayAuth
