# Cutover Z-API -> Evolution (site-clickup Railway)
# Uso: powershell -ExecutionPolicy Bypass -File scripts\railway_evolution_cutover.ps1
# Requer: railway CLI autenticado no projeto site-clickup
...
Variaveis obrigatorias (defina manualmente se ainda nao existirem):
  ...
  N8N_OUTBOUND_WEBHOOK_URL=<webhook n8n site-clickup-enviar-mensagem>
...
Outbound: Django -> n8n -> Evolution (instancia site_clickup_zap)
