# Cria/configura serviço Railway "site-clickup-pap" (worker Playwright dedicado).
...
$PapService = if ($env:RAILWAY_PAP_SERVICE) { $env:RAILWAY_PAP_SERVICE } else { "site-clickup-pap" }
