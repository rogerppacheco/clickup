/**
 * theme-toggle.js - ClickUp Dark/Light Mode v1.7
 * Persistência: localStorage['clickup-theme'] = 'dark' | 'light'
 */
(function () {
    'use strict';

    var STORAGE_KEY = 'clickup-theme';
    try {
    ...
    window.ClickUpTheme = window.ClickUpTheme;
}());
