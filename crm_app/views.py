...
# URL de produção: https://site-clickup-production.up.railway.app/api/crm/webhook-whatsapp/
# URL alternativa: https://site-clickup-production.up.railway.app/api/crm/webhook-whatsapp/
# Configurar webhook: Z-API ou Evolution (instancia site_clickup_zap)
# URL: https://site-clickup-production.up.railway.app/api/crm/webhook-whatsapp/
...
# Em site-clickup/crm_app/views.py
...
class ExportarAgendamentosDiaView(APIView):
    ...
    def get(self, request):
        ...
        for v in vendas:
            ...
            ws.append([
                getattr(settings, 'SITE_MODULE_PREFIX', 'ClickUp'),  # Parceiro
