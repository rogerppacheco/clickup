    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evento_gatilho', models.CharField(choices=[('NOVO_CDOI', 'Novo CDOI Solicitado (ClickUp Vertical)')], default='NOVO_CDOI', max_length=50)),
                ('destinos_grupos', models.JSONField(blank=True, default=list, verbose_name='Grupos de Destino (IDs)')),
                ('destinos_numeros', models.JSONField(blank=True, default=list, verbose_name='Números Individuais')),
                ('template_mensagem', models.TextField(default='🔔 *NOVO CDOI*\nCliente: {cliente}\nResp: {usuario}', help_text='Variáveis disponíveis: {id}, {cliente}, {sindico}, {contato}, {total_hps}, {usuario}, {link}', verbose_name='Modelo da Mensagem')),
            ],
            options={
