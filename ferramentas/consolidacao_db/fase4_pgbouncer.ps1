...
$ProjectSite = "7171eee1-2c6e-446a-b7a9-880d3786c51a"    # site-clickup
...
$siteServices = @("site-clickup", "site-clickup-webhook", "site-clickup-pap", "site-clickup-scheduler")
...
Write-Host ''
Write-Host '[1/4] site-clickup (4 servicos Django): pooled + unpooled' -ForegroundColor Yellow
foreach ($svc in $siteServices) {
