...
Consolida **sysr-vendas-api** e **syncwa-api** no Postgres central do projeto `site-clickup`, usando schemas dedicados:

| Schema   | Aplicação        | ORM    |
|----------|------------------|--------|
| `public` | site-clickup (Django) | Django |
...
- Python do projeto site-clickup (venv ou `railway run`)
