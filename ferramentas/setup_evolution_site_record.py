#!/usr/bin/env python3
"""
Provisiona instância Evolution `site_clickup_zap` e configura webhook do site-clickup.
...
Uso (variáveis de ambiente):
  ...
  EVOLUTION_INSTANCE_NAME=site_clickup_zap
  SITE_RECORD_WEBHOOK_URL=https://site-clickup-production.up.railway.app/api/crm/webhook-whatsapp/
...
DEFAULT_INSTANCE = "site_clickup_zap"
DEFAULT_WEBHOOK = "https://site-clickup-production.up.railway.app/api/crm/webhook-whatsapp/"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Setup Evolution site_clickup_zap")
    ...
    print("\nPróximos passos Railway (site-clickup — Opção B híbrida):")
    ...
    print("  N8N_OUTBOUND_WEBHOOK_URL=<webhook n8n site-clickup-enviar-mensagem>")
