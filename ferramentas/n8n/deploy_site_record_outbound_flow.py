#!/usr/bin/env python3
"""
Publica ou atualiza o fluxo outbound site-clickup no n8n (upsert + activate).
...
FLOW_FILE = Path(__file__).resolve().parent / "site-clickup-n8n-outbound-flow.json"
FLOW_NAME = "ClickUp — CRM → WhatsApp (Outbound)"
WEBHOOK_PATH = "site-clickup-enviar-mensagem"
