#!/usr/bin/env python3
"""
Publica ou atualiza o fluxo outbound Teams site-clickup no n8n (upsert + activate).
...
FLOW_FILE = Path(__file__).resolve().parent / "site-clickup-n8n-teams-outbound-flow.json"
FLOW_NAME = "ClickUp — CRM → Teams (Outbound)"
WEBHOOK_PATH = "site-clickup-teams-notificar"
...
def upsert_workflow(
    ...
    print("Criando workflow site-clickup Teams outbound")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Deploy fluxo n8n Teams outbound site-clickup")
    ...
    print()
    print("Variáveis Railway site-clickup:")
    print(f"  N8N_TEAMS_WEBHOOK_URL={expected_webhook}")
    print("  SITE_URL=https://site-clickup-production.up.railway.app")
    print()
