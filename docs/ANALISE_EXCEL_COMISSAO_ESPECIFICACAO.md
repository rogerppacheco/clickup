...
- Copie **COMISSÃO_RECORD_AGF.xlsx** para `c:\site-clickup\data\COMISSÃO_RECORD_AGF.xlsx`.
...
1. **Você:** Executar o script de export (ou copiar o xlsx para `c:\site-clickup\data\`) e disponibilizar os arquivos em `data/comissao_export/` (ou o próprio xlsx no projeto).
