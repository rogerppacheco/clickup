...
2. Opcional: `PAP_ONEDRIVE_FOLDER=NomeDaPasta` (padrão: `PAP_Screenshots`). Os arquivos ficam em `{MS_DRIVE_FOLDER_ROOT}/{PAP_ONEDRIVE_FOLDER}/`, por exemplo `CDOI_ClickUp_Vertical/PAP_Screenshots/`.
