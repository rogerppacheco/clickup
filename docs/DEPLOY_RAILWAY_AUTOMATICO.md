...
2. No GitHub: repositório **site-clickup** → **Settings** → **Secrets and variables** → **Actions** → **New repository secret**
   - Nome: `RAILWAY_TOKEN`
   - Valor: cole o token
3. **Actions** → workflow **Railway scheduler setup** → **Run workflow**.
4. No painel Railway, serviço **site-clickup-scheduler**:
...
## Projeto Railway (produção site-clickup)

- Projeto: **pleasing-recreation** (`7171eee1-2c6e-446a-b7a9-880d3786c51a`)
- Serviço web: **site-clickup**
- Serviço scheduler: **site-clickup-scheduler**

> **Nota:** `melodious-hope` é outro projeto (viabilidade); não usar para o site-clickup.
